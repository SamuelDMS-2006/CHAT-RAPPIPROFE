...
function w2({ children: l, initialPage: c, initialComponent: s, resolveComponent: p, titleCallback: a, onHeadUpdate: S2 }) {
  ...
  }, []), !d.component) return (0, import_react2.createElement)(A2.Provider, { value: u2 }, (0, import_react2.createElement)(E.Provider, { value: d.page }, null));
...
function W2(l, c) {
  ...
  let v2 = (0, import_react7.useCallback)((t, o, n = {}) => {
    let k2 = { ...n, onCancelToken: (m) => {
      ...
      if (x(false), R2(false), clearTimeout(P.current), n.onBefore) return n.onBefore(m);
    }, onStart: (m) => {
